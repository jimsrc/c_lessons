...
exe 'vert 2resize ' . ((&columns * 75 + 81) / 162)
exe 'vert 3resize ' . ((&columns * 86 + 81) / 162)
argglobal
...
silent! normal! zE
let s:l = 45 - ((10 * winheight(0) + 13) / 27)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 27 - ((18 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
